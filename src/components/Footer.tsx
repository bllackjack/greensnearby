...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#89F336] text-[#244709] py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">

          <div className="footer-section flex flex-col justify-center items-center">
          <img src="/logo.gif" alt="Logo" className="h-25 w-auto" />
          <h1 className='text-2xl text-[#244709] font-bold'>GreensNearBy</h1>
          </div> 
          {/* Contact Us */}
          <div className="footer-section">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <a href="mailto:info@greensnearby.com" className="hover:text-sage-green transition-colors">
                  info@greensnearby.com
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4" />
                <span className="text-[#244709]">(555) 123-GREEN</span>
              </div>
            </div>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#sell" className="hover:text-sage-green transition-colors">
                  Sell Your Greens
                </a>
              </li>
              <li>
                <a href="#buy" className="hover:text-sage-green transition-colors">
                  Find Fresh Produce
                </a>
              </li>
              <li>
          ...
          <div className="footer-section">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="hover:text-sage-green transition-colors p-2 hover:bg-white/10 rounded-full"
                aria-label="Facebook"
              >
